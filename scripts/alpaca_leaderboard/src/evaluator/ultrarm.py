...
class UltraRMEvaluator(BaseEvaluator):
    def __post_init__(self):
        ...
        self.tokenizer = LlamaTokenizer.from_pretrained("openbmb/UltraRM-13b")
        self.model = LlamaRewardModel.from_pretrained("openbmb/UltraRM-13b", torch_dtype=torch.bfloat16).cuda()
